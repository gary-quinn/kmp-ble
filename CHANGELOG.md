...
### Added
- feat(l2cap): add `L2capChannelState`, `L2capChannel.errors`, `close(graceful)`, and `recover()` for CoC client channels
...
- feat(sample): add v0.10.x features, consolidate Android module, update README
...
- feat(mesh): add BLE Mesh networking module (Phase 1)
...
- ci(dependabot): bump actions/setup-java from 5.5.0 to 5.6.0
- ci(dependabot): bump actions/checkout from 4.3.1 to 7.0.0
- build(dependabot): bump kotlin from 2.4.0 to 2.4.10
- build(dependabot): bump agp from 9.2.1 to 9.3.0
- build(dependabot): bump androidxLifecycle from 2.10.0 to 2.11.0
- build(dependabot): bump agp from 9.3.0 to 9.3.1
...
- build(dependabot): bump org.jetbrains.lincheck:lincheck from 3.6 to 3.7
...
- fix(security): bump logback 1.5.25→1.5.35 and jackson 2.18.6→2.18.9
- fix(android): wire ObservationPersistence.context + warn when legacyOnly hides Extended Advertising
- fix(scanner): keep post-filter-only groups as wildcard OS filters on Android
...
[0.12.0]: https://github.com/gary-quinn/kmp-ble/compare/v0.11.2...v0.12.0
[0.11.2]: https://github.com/gary-quinn/kmp-ble/compare/v0.11.1...v0.11.2
[0.11.1]: https://github.com/gary-quinn/kmp-ble/compare/v0.11.0...v0.11.1
[0.11.0]: https://github.com/gary-quinn/kmp-ble/compare/v0.10.3...v0.11.0
[0.10.3]: https://github.com/gary-quinn/kmp-ble/compare/v0.10.2...v0.10.3
[0.10.2]: https://github.com/gary-quinn/kmp-ble/compare/v0.10.1...v0.10.2
[0.10.1]: https://github.com/gary-quinn/kmp-ble/compare/v0.10.0...v0.10.1
