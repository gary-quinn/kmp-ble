...
public class OemQuirkProvider : QuirkProvider {
    ...
    private companion object {
        ...
        val BOND_BEFORE_CONNECT: Set<String> =
            setOf(
                // Galaxy S21 series
                "samsung:sm-g99",
                // Galaxy S20 series
        ...
        val GATT_RETRY_COUNT: Map<String, Int> =
            mapOf(
                "google" to 3,
                "google:pixel" to 3,
                "samsung" to 2,
        ...
        val BOND_STATE_TIMEOUT: Map<String, Duration> =
            mapOf(
        ...
        val CONNECTION_TIMEOUT: Map<String, Duration> =
            mapOf(
