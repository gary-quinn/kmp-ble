...
class AndroidPeripheralGATTTest {
    ...
    @Test
    fun `connection state change to connected is processed`() =
        runBlocking(Dispatchers.Default) {
            // Arrange
    ...
    @Test
    fun `connection state change to disconnected is processed`() =
        runBlocking(Dispatchers.Default) {
            // Arrange
            val stateFlow = peripheral.state
    ...
    @Test
    fun `services discovered callback updates peripheral services`() =
        runBlocking(Dispatchers.Default) {
            // Arrange
    ...
    @Test
    fun `characteristic read callback completes pending operation`() =
        runBlocking(Dispatchers.Default) {
            // Arrange
    ...
    @Test
    fun `characteristic write callback completes pending operation`() =
        runBlocking(Dispatchers.Default) {
            // Arrange
    ...
    @Test
    fun `characteristic changed callback delivers notification`() =
        runBlocking(Dispatchers.Default) {
            // Arrange
    ...
    @Test
    fun `descriptor read callback completes pending operation`() =
        runBlocking(Dispatchers.Default) {
            // Arrange
    ...
    @Test
    fun `descriptor write callback completes pending operation`() =
        runBlocking(Dispatchers.Default) {
            // Arrange
    ...
    @Test
    fun `MTU changed callback updates peripheral MTU`() =
        runBlocking(Dispatchers.Default) {
            // Arrange
            val newMtu = 512
    ...
    @Test
    fun `phy updated callback delivers update`() =
        runBlocking(Dispatchers.Default) {
            // Arrange
            val txPhy = 2 // LE 2M
            val rxPhy = 2 // LE 2M
    ...
    @Test
    fun `phy read callback delivers update`() =
        runBlocking(Dispatchers.Default) {
            // Arrange
            val txPhy = 1 // LE 1M
            val rxPhy = 1 // LE 1M
    ...
    @Test
    fun `RSSI read callback delivers value`() =
        runBlocking(Dispatchers.Default) {
            // Arrange
            val rssi = -55
    ...
    @Test
    fun `subrate changed callback with success reports accepted`() =
        runBlocking(Dispatchers.Default) {
            @OptIn(ExperimentalBleApi::class)
            val subrateFactor = 2
    ...
    @Test
    fun `subrate changed callback with error reports rejected`() =
        runBlocking(Dispatchers.Default) {
            @OptIn(ExperimentalBleApi::class)
            val subrateFactor = 2
            val subrateLatency = 0
    ...
    @Test
    fun `multiple characteristics can be observed simultaneously`() =
        runBlocking(Dispatchers.Default) {
    ...
    @Test
    fun `peripheral cleanup closes bridge`() =
        runBlocking(Dispatchers.Default) {
            // Act
            peripheral.close()
