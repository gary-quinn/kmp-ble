...
class ObservationReconnectionTest {
    ...
    @Test
    fun observeSurvivesDisconnectAndReconnect() = runTest {
    ...
    @Test
    fun observeValuesTransparentlyReconnects() = runTest {
        val peripheral = createPeripheral()
        peripheral.connect()
    ...
    @Test
    fun observeCompletesOnPermanentDisconnect() = runTest {
        val peripheral = createPeripheral()
        peripheral.connect()
    ...
    @Test
    fun observeValuesCompletesOnPermanentDisconnect() = runTest {
        val peripheral = createPeripheral()
        peripheral.connect()
    ...
    @Test
    fun cccdRewrittenOnReconnect() = runTest {
        val peripheral = createPeripheral()
        peripheral.connect()
    ...
    @Test
    fun characteristicRemovedOnReconnectCompletesObservation() = runTest {
        val peripheral = createPeripheral()
        peripheral.connect()
    ...
    @Test
    fun observeEmitsDisconnectedThenResumesOnReconnect() = runTest {
        val peripheral = createPeripheral()
        peripheral.connect()
