...
class FakeExtendedAdvertiserTest {
    ...
    @Test
    fun startAndStopAdvertisingSet() = runTest {
    ...
    @Test
    fun multipleConcurrentSets() = runTest {
        val advertiser = FakeExtendedAdvertiser()
    ...
    @Test
    fun configPreservesPhyFields() = runTest {
        val advertiser = FakeExtendedAdvertiser()
    ...
    @Test
    fun startAfterCloseThrows() = runTest {
        val advertiser = FakeExtendedAdvertiser()
        advertiser.close()
