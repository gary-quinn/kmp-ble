...
class L2capChannelTest {
    ...
    @Test
    fun writeRecordsMultipleWrites() =
        runTest {
            val channel = FakeL2capChannel(psm = 0x25)
    ...
    @Test
    fun writeThrowsChannelClosedAfterClose() =
        runTest {
            val channel = FakeL2capChannel(psm = 0x25)
            channel.close()
    ...
    @Test
    fun openL2capChannelSucceedsWhenConnected() =
        runTest {
            val peripheral =
                FakePeripheral {
                    onOpenL2capChannel { psm -> FakeL2capChannel(psm) }
    ...
    @Test
    fun openL2capChannelThrowsNotSupportedWithoutHandler() =
        runTest {
    ...
    @Test
    fun openL2capChannelPassesPsmToHandler() =
        runTest {
            var receivedPsm = -1
            val peripheral =
                FakePeripheral {
    ...
    fun allExceptionsAreSealedSubtypes() {
        val exceptions: List<L2capException> =
            listOf(
