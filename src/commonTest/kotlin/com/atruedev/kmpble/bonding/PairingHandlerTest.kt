...
class PairingHandlerTest {
    ...
    @Test
    fun handlerReceivesNumericComparison() = runTest {
    ...
    @Test
    fun handlerReceivesPasskeyRequest() = runTest {
    ...
    fun allPairingEventsAreSealed() {
        val events: List<PairingEvent> = listOf(
    ...
    fun allPairingResponsesAreSealed() {
        val responses: List<PairingResponse> = listOf(
            PairingResponse.Confirm(true),
