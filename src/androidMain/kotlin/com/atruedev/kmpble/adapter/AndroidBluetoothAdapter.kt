...
public class AndroidBluetoothAdapter(
    ...
    override val state: StateFlow<BluetoothAdapterState> = callbackFlow {
        // Emit initial state
    ...
    private fun currentState(): BluetoothAdapterState {
        ...
        val hasScan = context.checkPermission(
        ...
        return when (adapter.state) {
            ...
            android.bluetooth.BluetoothAdapter.STATE_TURNING_OFF -> BluetoothAdapterState.Unavailable
