...
- [~] #334: feat(parity): add client-side BondManager interface with iOS implementation [enhancement]
...
- [ ] #363: feat(le-audio): add LE Audio Isochronous Channels streaming API for Bluetooth 5.2+ [enhancement]
- [ ] #338: feat(parity): add Periodic Advertising Sync Transfer (PAST) support (Bluetooth 5.1+) [enhancement]
- [ ] #368: feat(parity): add BLE Direction Finding (AoA/AoD) API for Bluetooth 5.1+ [enhancement]
- [ ] #318: feat(connection): add LE Connection Subrating support (Bluetooth 5.3) [enhancement]
...
## Testing
- [ ] #339: test(observation): add ObservationPersistence cross-platform roundtrip tests [enhancement, testing]
