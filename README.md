...
kotlin {
    sourceSets {
        commonMain.dependencies {
            ...
            implementation("com.atruedev:kmp-ble-dfu:0.8.1")
            implementation("com.atruedev:kmp-ble-codec:0.8.1")
            implementation("com.atruedev:kmp-ble-codec-serialization:0.8.1")
        }
    }
}
```
