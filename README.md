...
kotlin {
    sourceSets {
        commonMain.dependencies {
            implementation("com.atruedev:kmp-ble:0.8.3")

            // Optional modules
            implementation("com.atruedev:kmp-ble-profiles:0.8.3")
            implementation("com.atruedev:kmp-ble-dfu:0.8.3")
            implementation("com.atruedev:kmp-ble-codec:0.8.3")
            implementation("com.atruedev:kmp-ble-codec-serialization:0.8.3")
        }
    }
}
```
