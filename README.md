...
kotlin {
    sourceSets {
        commonMain.dependencies {
            implementation("com.atruedev:kmp-ble:0.10.0")

            // Optional modules
            implementation("com.atruedev:kmp-ble-profiles:0.10.0")
            implementation("com.atruedev:kmp-ble-dfu:0.10.0")
            implementation("com.atruedev:kmp-ble-codec:0.10.0")
            implementation("com.atruedev:kmp-ble-codec-serialization:0.10.0")
        }
    }
}
```
