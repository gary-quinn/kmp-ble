...
kotlin {
    sourceSets {
        commonMain.dependencies {
            implementation("com.atruedev:kmp-ble:0.4.3")

            // Optional modules
            implementation("com.atruedev:kmp-ble-profiles:0.4.3")
            implementation("com.atruedev:kmp-ble-dfu:0.4.3")
            implementation("com.atruedev:kmp-ble-codec:0.4.3")
        }
    }
}
```
