...
kotlin {
    sourceSets {
        commonMain.dependencies {
            implementation("com.atruedev:kmp-ble:0.3.12")

            // Optional modules
            implementation("com.atruedev:kmp-ble-profiles:0.3.12")
            implementation("com.atruedev:kmp-ble-dfu:0.3.12")
            implementation("com.atruedev:kmp-ble-codec:0.3.12")
        }
    }
}
```
